import { DefaultOperation as Model } from '../models/DefaultOperation';
...
export class DefaultOperation extends Seed {
  ...
  public static Seed(log: Boolean = true) {
    ...
    return defaultOperation.Executar(log);
  }
  ...
  public async Mock() {
    ...
    await this.controller.getRepositoryEntity().save(<Model><unknown>{
      "id": 2,
      "description":"Limpeza dos Componentes.",
      "deleted": false,
      "createdBy": 1,
      "updatedBy": 1,
      "createdAt": "2020-06-04 22:16:46",
